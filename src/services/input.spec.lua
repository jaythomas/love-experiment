describe('services/input', function()
  ...
  describe('is_paused/toggle_paused', function()
    it('should exist', function()
      assert.equal(type(service.is_paused), 'function')
      assert.equal(type(service.toggle_paused), 'function')
    end)

    it('should toggle the paused state', function()
      assert.equal(service.is_paused(), false)
      service.toggle_paused()
      assert.equal(service.is_paused(), true)
    end)
  end)
